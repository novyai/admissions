...
export const OLMPA_BASE_URL =
  isQA ? "admissions-olmpa-production.up.railway.app" : "admissions-olmpa-production.up.railway.app"

export const WS_BASE_URL =
  isQA ? "asmissions-ws-production.up.railway.app" : "asmissions-ws-production.up.railway.app"
