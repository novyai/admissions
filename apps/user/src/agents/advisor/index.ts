...
- **display-course**: An action that displays a singular course. Do not worry about having access to the data. You should use actions instead of listing out courses.
`
