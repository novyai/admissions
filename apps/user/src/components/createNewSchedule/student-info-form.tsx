...
import { UniversityProgram } from "./action"
...
export function StudentInfoForm({
  ...
  const tracks = universityPrograms
    .map(university =>
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    handleSubmit({
      ...
      tracks: result.data.majors.map(option => option.value),
      start: {
  ...
  const programsForUniversity = () => {
    ...
    return tracks.filter(program => program.universityId === universityId)
  }
